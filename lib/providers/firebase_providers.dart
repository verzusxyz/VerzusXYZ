...
final availableMatchesProvider = StreamProvider.family<List<MatchModel>, String?>((ref, skillTopic) {
...
final activeTournamentsProvider = StreamProvider<List<Map<String, dynamic>>>((ref) {
...
final tournamentParticipantsProvider = StreamProvider.family<List<Map<String, dynamic>>, String>((ref, tournamentId) {
  final tournamentRepo = ref.read(tournamentRepositoryProvider);
...
final userSearchProvider = FutureProvider.family<List<UserModel>, String>((ref, searchTerm) async {
...
final gameSearchProvider = FutureProvider.family<List<GameModel>, String>((ref, searchTerm) async {
  if (searchTerm.trim().isEmpty) return [];
  final gameRepo = ref.read(gameRepositoryProvider);
  ...
  return currentUser.when(
    data: (user) {
      ...
      return {
        ...
        'winRate': user.totalMatches > 0 ? (user.totalWins / user.totalMatches * 100).toStringAsFixed(1) : '0.0',
