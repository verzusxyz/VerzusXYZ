        ...
        body: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: VerzusColors.dangerRed.withValues(alpha: 0.3)),
            ),
            child: Column(
              ...
              children: [
                ...
                const Text('Your account is not permitted to access the admin dashboard.'),
              ],
            ),
          ),
        ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(g.platform.toUpperCase(), style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Theme.of(context).colorScheme.onSurfaceVariant)),
                  ],
                ),
              ),
              VerzusButton.outline(
                onPressed: () => ref.read(gamesServiceProvider).deleteGame(g.gameId),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: VerzusColors.warningYellow, fontWeight: FontWeight.w600),
                    ),
                  ),
                ],
              ),
              ...
              VerzusButton.outline(
                onPressed: () async {
                  await ref.read(resultTrackerProvider).refundDispute(matchId: m.id);
                },
      ...
      child: ClipRRect(
        ...
        child: Stack(
          ...
          children: [
            ...
            if (crop != null) ...[
              _RectOverlay(rect: crop!.scoreRect, color: Colors.green.withValues(alpha: 0.35), label: 'Score'),
              _RectOverlay(rect: crop!.usernameRect, color: Colors.blue.withValues(alpha: 0.35), label: 'Username'),
            ]
          ],
        ),
      ),
...
class _RectOverlay extends StatelessWidget {
  ...
  final Color color;
  final String label;
  const _RectOverlay({required this.rect, required this.color, required this.label});
