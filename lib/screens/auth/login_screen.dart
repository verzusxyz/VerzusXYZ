                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: TextButton(
                            ...
                            child: Text(
                              'Forgot Password?',
                              style: TextStyle(color: VerzusColors.primaryPurple),
                            ),
                          ),
                        ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: VerzusColors.accentGreen.withValues(alpha: 0.1),
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                              color: VerzusColors.accentGreen.withValues(alpha: 0.3),
                            ),
                          ),
                          child: Column(
                            children: [
