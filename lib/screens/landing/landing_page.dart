    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: PageView(
          ...
          children: [
            _section(_heroKey, _HeroSection(
            ...
            _section(_joinKey, _JoinSection(
              onJoinNow: () => context.go('/auth/login'),
            )),
            _section(_ctaKey, _CTASection(
              onGetStarted: () => context.go('/auth/login'),
            )),
          ],
        ),
  ...
  final List<Map<String, String>> faqs = const [
    {
      ...
      'a': 'Yes — signing up and joining many tournaments is free. Some premium events may have entry conditions.'
    },
    {
      'q': 'How do I earn rewards?',
      'a': 'Win tournaments, complete challenges, or place on leaderboards. Rewards are verified and credited to your Verzus wallet.'
    },
    {
      'q': 'What games can I play?',
      'a': 'We support popular mobile and console titles — and we add new titles based on player demand.'
    },
    {
      'q': 'How do payouts work?',
      'a': 'Confirmed winners get payouts to the Verzus wallet. Withdrawals use supported local payment rails.'
    },
    {
      'q': 'Can I host tournaments?',
      'a': 'Yes — verified creators and partners can host tournaments with custom rules and prizes.'
    },
    {
      'q': 'Is cheating prevented?',
      'a': 'We use anti-cheat logic, reporting, and manual verification where required to keep play fair.'
    },
    {
      'q': 'How can I get help?',
      'a': 'Use the in-app support chat or contact support@verzus.xyz for assistance.'
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: theme.colorScheme.surfaceContainerHighest ??
          theme.colorScheme.surface, // fallback
