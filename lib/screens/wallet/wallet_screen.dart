...
class _WalletScreenState extends ConsumerState<WalletScreen> with TickerProviderStateMixin {
            ...
            child: walletAsync.when(
              ...
              data: (walletData) {
                ...
                final total = mode == WalletKind.live
                    ? (walletData['live_balance'] ?? 0.0) + (walletData['live_pending'] ?? 0.0)
                    : (walletData['demo_balance'] ?? 0.0) + (walletData['demo_pending'] ?? 0.0);
  ...
  Widget _buildErrorCard(String error) {
    return Padding(
      ...
      child: Column(
        children: [
          Icon(Icons.error_outline, color: Colors.white.withOpacity(0.7), size: 48),
          const SizedBox(height: 16),
          Text('Wallet Error', style: TextStyle(color: Colors.white, fontSize: 18)),
          const SizedBox(height: 8),
          Text(error, style: TextStyle(color: Colors.white.withOpacity(0.7)), textAlign: TextAlign.center),
          const SizedBox(height: 16),
          VerzusButton(
  ...
  Widget _buildEmptyWalletCard() {
    return Padding(
      ...
      child: Column(
        children: [
          Icon(Icons.wallet_outlined, color: Colors.white.withOpacity(0.7), size: 48),
          const SizedBox(height: 16),
          Text('No Wallet', style: TextStyle(color: Colors.white, fontSize: 18)),
          const SizedBox(height: 8),
          Text('Create your first deposit', style: TextStyle(color: Colors.white.withOpacity(0.7))),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
          decoration: BoxDecoration(
            color: selected ? VerzusColors.primaryPurple.withOpacity(0.15) : Colors.transparent,
            borderRadius: BorderRadius.circular(999),
          ),
          child: Text(
            label,
