...
class FirebaseClientService {
  ...
  Future<UserModel?> getUserProfile(String uid) async {
    try {
      ...
      throw FirebaseClientException('Failed to get user profile: ${e.toString()}');
    }
  }
  ...
  Future<void> updateUserProfile(String uid, Map<String, dynamic> updates) async {
    try {
      ...
      throw FirebaseClientException('Failed to update user profile: ${e.toString()}');
    }
  }
  ...
  Future<void> submitMatchResult({
    ...
    try {
      ...
      throw FirebaseClientException('Failed to submit match result: ${e.toString()}');
    }
  }
  ...
  Future<String> createTournament(Map<String, dynamic> tournament) async {
    try {
      ...
      throw FirebaseClientException('Failed to create tournament: ${e.toString()}');
    }
  }
  ...
  Future<void> joinTournament(String tournamentId, String userId) async {
    try {
      await _firestore.runTransaction((transaction) async {
        ...
        final participantRef = _firestore.collection(FirestoreSchema.tournamentParticipants).doc();
      ...
      throw FirebaseClientException('Failed to join tournament: ${e.toString()}');
    }
  }
  ...
  Future<Map<String, dynamic>?> getUserWallet(String userId) async {
    try {
      final doc = await _firestore.collection(FirestoreSchema.wallets).doc(userId).get();
  ...
  Future<String> createWalletTransaction({
    ...
    try {
      final transactionRef = _firestore.collection(FirestoreSchema.walletTransactions).doc();
      ...
      throw FirebaseClientException('Failed to create wallet transaction: ${e.toString()}');
    }
  }
  ...
  Future<void> updateLeaderboard({
    ...
    try {
      ...
      await _firestore.collection(FirestoreSchema.leaderboardEntries).doc(entryId).set({
      ...
      throw FirebaseClientException('Failed to update leaderboard: ${e.toString()}');
    }
  }
  ...
  Future<Map<String, dynamic>?> getSystemSetting(String key) async {
    try {
      ...
      throw FirebaseClientException('Failed to get system setting: ${e.toString()}');
    }
  }
