...
final firebaseInitializationProvider = Provider<FirebaseInitializationService>((ref) {
...
class FirebaseInitializationService {
  FirebaseInitializationStatus _status = FirebaseInitializationStatus.notInitialized;
  ...
  Map<String, dynamic> getFirebaseInfo() {
    try {
      ...
      return {
        ...
        'apiKey': app.options.apiKey.substring(0, 10) + '...', // Partial for security
