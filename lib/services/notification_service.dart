...
class NotificationService {
  ...
  Future<void> sendMatchStartingNotification(
      String userId, String opponentName) async {
  ...
  Future<void> _sendPersonalizedMatchNotification({
    ...
    if (winner != null && loser != null) {
      final winnerScore = match.creatorId == winnerId
          ? match.creatorScore
          : match.opponentScore;
      final loserScore =
          match.creatorId == loserId ? match.creatorScore : match.opponentScore;
