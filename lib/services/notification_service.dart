...
class NotificationService {
  ...
  Future<void> sendMatchWinNotification(String winnerId, String loserId, double prizeAmount, String matchId) async {
  ...
  Future<void> sendMatchLossNotification(String loserId, String winnerId, double prizeAmount, String matchId) async {
    final match = await _ref.read(matchRepositoryProvider).getMatch(matchId);
    if (match != null) {
      await _sendPersonalizedMatchNotification(
        winnerId: winnerId,
