...
class FirebaseUtils {
  ...
  static Query applyPagination(Query query, {
  ...
  static bool isUserOwner(Map<String, dynamic> document, String? userId) {
    ...
    final ownerId = document['owner_id'] ?? document['user_id'] ?? document['creator_id'];
  ...
  static Future<void> enableOfflinePersistence() async {
    try {
      ...
      print('Firestore persistence configuration handled during initialization');
    } catch (e) {
  ...
  static const String transactionsCollection = FirestoreSchema.walletTransactions;
}
